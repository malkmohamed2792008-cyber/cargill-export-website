...
export default function Testimonials() {
  return (
    <section role="region" aria-label="Testimonials" className="section bg-background-alt relative overflow-hidden">
      {/* Background Accent */}
      ...
      <div className="container-main relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              {/* Quote Icon */}
              <div className="text-accent mb-6" aria-hidden>
                <FaQuoteLeft className="w-10 h-10" />
              </div>

              {/* Quote */}
              <p className="text-foreground-secondary mb-8 leading-relaxed italic">&ldquo;{testimonial.quote}&rdquo;</p>
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-border-light">
                ...
                />
                <div>
                  <h4 id={`testimonial-${testimonial.id}-name`} className="font-semibold text-primary">{testimonial.name}</h4>
                  <p className="text-sm text-foreground-secondary">{testimonial.position}, {testimonial.company}</p>
